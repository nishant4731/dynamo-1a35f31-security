...
The intended repair preserves the visible bundle semantics while making path resolution race resistant, auditing the initial target as a closed hardlink graph, rejecting unsafe object types and metadata, and applying updates atomically. The verifier exercises fresh semantic combinations and a deterministic concurrent path-swap attack.
